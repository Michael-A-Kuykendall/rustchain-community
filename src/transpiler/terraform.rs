...
output "instance_ip" {
  value = aws_instance.web.public_ip
    ...
    fn test_resource_type_mapping() {
        assert!(matches!(TerraformParser::step_type_for("aws_instance"), StepType::Http));
        assert!(matches!(TerraformParser::step_type_for("local_file"), StepType::CreateFile));
        assert!(matches!(TerraformParser::step_type_for("null_resource"), StepType::Command));
        assert!(matches!(TerraformParser::step_type_for("kubernetes_deployment"), StepType::Http));
    }
